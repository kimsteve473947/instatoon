...
export const SUBSCRIPTION_PLANS = {
  ...
  HEAVY: {
    ...
    name: "헤비유저",
    price: 100000,
    tokens: 25000,    // 2500이미지/월 (40원/이미지)
    characters: 5,
    projects: Infinity,
  ...
  ENTERPRISE: {
    ...
    name: "기업",
    price: 200000,
    tokens: 60000,    // 6000이미지/월 (33원/이미지)
    characters: Infinity,
    projects: Infinity,
...
export async function createBillingAuthRequest(
  ...
  return {
    ...
    successUrl: `${process.env.NEXT_PUBLIC_APP_URL}/api/payments/billing-success?planId=${planId}&customerKey=${customerKey}`,
